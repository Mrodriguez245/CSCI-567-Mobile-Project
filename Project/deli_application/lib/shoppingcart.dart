...
import 'bloc/shoppingCartListColorTheme.dart';
import 'const/appTheme.dart';
...
class BottomBar extends StatelessWidget {
  ...
  Container totalAmount(List<DeliItem> foodItems) {
    return Container(
      margin: EdgeInsets.only(right: 10),
  ...
  String returnTotalAmount(List<DeliItem> foodItems) {
...
class _DragTargetWidgetState extends State<DragTargetWidget> {
  @override
  Widget build(BuildContext context) {
    DeliItem currentFoodItem;
    final ColorBloc colorBloc = BlocProvider.getBloc<ColorBloc>();

    return DragTarget<DeliItem>(
      onAccept: (DeliItem deliItem) {
        currentFoodItem = deliItem;
        colorBloc.setColor(Colors.white);
        widget.bloc.removeFromList(currentFoodItem);
      },
      onWillAccept: (DeliItem deliItem) {
        colorBloc.setColor(Colors.red);
        return true;
      },
      onLeave: (DeliItem foodItem) {
        colorBloc.setColor(Colors.white);
      },
